...
export const InsightsSection: React.FC<InsightsSectionProps> = ({ insights, heading, intro }) => (
    <section className="py-32 bg-[#111111] text-white"><div className="mx-auto max-w-[1400px] px-6"><div className="mb-20"><h2 className="font-serif text-5xl mb-6">{heading}</h2><p className="text-gray-400 max-w-xl"><FormattedText text={intro} /></p></div><div className="grid grid-cols-1 md:grid-cols-2 gap-8">{insights.map((i, idx) => (
